<nav class="sidebar-nav">
    <ul id="sidebarnav">
        ...
        <li>
            <a class="waves-effect waves-dark" href="<?php echo base_url()?>admin/tabel_masakan"><i class="mdi mdi-gauge"></i><span class="hide-menu">Masakan</span></a>
        </li>
        <li>
            <a class="waves-effect waves-dark" href="<?php echo base_url()?>admin/tabel_user"><i class="mdi mdi-gauge"></i><span class="hide-menu">User</span></a>
        </li>
        <!-- //BATAS SATU MENU -->
